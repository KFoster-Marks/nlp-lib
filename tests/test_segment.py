...
class SegmentTestSuite(unittest.TestCase):
    ...
    #     assert src.get_custom_segment(text, delimiter) == ['Not everyone agrees on the best way to build software;', 'many argue over the costs and benefits of waterfall versus agile, for example.']
